...
$img              = mysqli_real_escape_string($connection,$_GET["reciepeImg"]);

$query = 'INSERT INTO dbShnkr22studWeb1.tbl_redding_reciepes_210 (reciepe_name, prep_time, img_url, description, category, ingrediants,directions, user_id ) VALUES ("'.$reciepe_name.'" , "'.$prep_time.'", "'.$img .'", "description", "'.$reciepe_category.'", "'.$ingrediants.'", "'.$directions.'" , "'.$user_id.'"); ';
